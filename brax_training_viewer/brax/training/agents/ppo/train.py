...
streamer = WebSocketStateStreamer(fps=50)
streamer.start()
...
def train(
  ...
  def training_step(
    ...
    def f(carry, unused_t):
      ...
      # TODO TODO
      jax.debug.callback(streamer.send, current_state.pipeline_state)
  ...
  def training_epoch_with_timing(
    ...
    # #TODO TODO
    # to_send = _unpmap(env_state).pipeline_state
    # print("\n\n================\n", to_send,"\n================\n")
    # streamer.send(_unpmap(to_send))
